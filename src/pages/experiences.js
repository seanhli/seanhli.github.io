...
function Experiences() {
  ...
  const content = [
    ...
    ["SessionM / Mastercard", "Designed, managed, and optimized rewards programs for industry leaders as a Senior Analyst. Redesigned productized loyalty reporting as Product Owner", "2017 - 2021"],
    ["Dartmouth College", "Graduated with a B.A in both Economics and Japanese. Served as a James O. Freedman Presidential Scholar and Ambassador of the Guarini Student Board", "2013 - 2017"],
    ["Tuck Business School", "Selected to participate in the Tuck Business Bridge Program for prospective business leaders", "2016"],
  ];
